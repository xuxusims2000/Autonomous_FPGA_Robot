...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot L293D_0 xil_defaultlib.L293D_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim L293D_0 -key {Behavioral:sim_1:Functional:L293D_0} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="H:/Vivado/2022.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb L293D_0.wdb xsim.dir)
