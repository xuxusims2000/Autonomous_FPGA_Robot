...
-- Command     : write_vhdl -force -mode funcsim -rename_top L293D_1 -prefix
--               L293D_1_ L293D_0_sim_netlist.vhdl
-- Design      : L293D_0
...
end L293D_1_DEBOUNCING;

architecture STRUCTURE of L293D_1_DEBOUNCING is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity L293D_1_DEBOUNCING_0 is
  port (
    tmp2 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of L293D_1_DEBOUNCING_0 : entity is "DEBOUNCING";
end L293D_1_DEBOUNCING_0;

architecture STRUCTURE of L293D_1_DEBOUNCING_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity L293D_1_DEBOUNCING_1 is
  port (
    tmp3 : out STD_LOGIC;
    slow_clk_en : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of L293D_1_DEBOUNCING_1 : entity is "DEBOUNCING";
end L293D_1_DEBOUNCING_1;

architecture STRUCTURE of L293D_1_DEBOUNCING_1 is
begin
Q_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity L293D_1_DEBOUNCING_2 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of L293D_1_DEBOUNCING_2 : entity is "DEBOUNCING";
end L293D_1_DEBOUNCING_2;

architecture STRUCTURE of L293D_1_DEBOUNCING_2 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity L293D_1_PWM_generator is
  port (
...
end L293D_1_PWM_generator;

architecture STRUCTURE of L293D_1_PWM_generator is
...
stage0: entity work.L293D_1_DEBOUNCING
     port map (
      DI(0) => DUTY_CYCLE1,
...
stage1: entity work.L293D_1_DEBOUNCING_0
     port map (
      DI(0) => DUTY_CYCLE1,
...
stage2: entity work.L293D_1_DEBOUNCING_1
     port map (
      Q(0) => Q(1),
      s00_axi_aclk => s00_axi_aclk,
      slow_clk_en => slow_clk_en,
...
stage3: entity work.L293D_1_DEBOUNCING_2
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity L293D_1_L293D_v1_0_S00_AXI is
  port (
...
end L293D_1_L293D_v1_0_S00_AXI;

architecture STRUCTURE of L293D_1_L293D_v1_0_S00_AXI is
  signal D : STD_LOGIC;
...
PWM_instance: entity work.L293D_1_PWM_generator
     port map (
      Backward => Backward,
      Forward => Forward,
      PWM_OUT => PWM_OUT,
...
end L293D_1_L293D_v1_0;

architecture STRUCTURE of L293D_1_L293D_v1_0 is
begin
L293D_v1_0_S00_AXI_inst: entity work.L293D_1_L293D_v1_0_S00_AXI
     port map (
      Backward => Backward,
      Forward => Forward,
      PWM_OUT => PWM_OUT,
...
entity L293D_1 is
  ...
  attribute NotValidForBitStream of L293D_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of L293D_1 : entity is "L293D_0,L293D_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of L293D_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of L293D_1 : entity is "L293D_v1_0,Vivado 2022.1";
end L293D_1;

architecture STRUCTURE of L293D_1 is
...
U0: entity work.L293D_1_L293D_v1_0
     port map (
      Backward => Backward,
      Forward => Forward,
      PWM_OUT => PWM_OUT,
